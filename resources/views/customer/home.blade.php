        ...
        <div class="container-fluid about py-5">
            <div class="container py-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url('{{ asset('customer/img/about-img-1.png') }}');">
                ...
                <div class="testimonial-carousel owl-carousel">
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div class="testimonial-img p-1">
                            <img src="{{ asset('customer/img/usersnew.jpg') }}" class="img-fluid rounded-circle" alt="Image">
                        </div>
            ...
            <div class="container py-5">
                ...
                <div class="testimonial-carousel owl-carousel">
                    ...
                    <div class="testimonial-item text-center rounded pb-4">
                        ...
                        <div style="margin-top: -35px;">
                            <h5 class="mb-0">John Abraham</h5>
                            <p class="mb-0">Gujarat, Ahmedabad</p>
                            <div class="d-flex justify-content-center">
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
                                <i class="fas fa-star text-primary"></i>
...
<div class="container-fluid py-5 bg-light">
    <div class="container text-center">
        <h5 class="section-title px-3">Our Videos</h5>
        <h1 class="mb-5">Watch What Our Clients Projects</h1>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <h5 class="mt-3">Aluminium Fabrication Work</h5>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <h5 class="mt-3">UPVC Window & Door Installation</h5>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <h5 class="mt-3">Wooden Door & Window Carpentry</h5>
            </div>
        </div>
    </div>
</div>
